...
plt.tight_layout()
plt.savefig(f'Distribution {len(all_subsets)}, n={unlabeled}, k={label_budget} with Counts, Noise={margin} equal.png')
...
plt.tight_layout()
plt.savefig(f'NN_vs_RF_distribution(n={unlabeled}, k={label_budget}, noise={margin}, {len(all_subsets)} equal).png')